...
domain, cell_tags, facet_tags = gmshio.read_from_msh("square_regular.msh", MPI.COMM_SELF,0, gdim=2)
...
dofs_2 = fem.locate_dofs_topological(V, facet_tags.dim, facet_tags.find(8))

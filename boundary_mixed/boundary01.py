...
boundary_dofs_b = fem.locate_dofs_topological((V.sub(0), V0), fdim, facet_tag.find(1))
bc0 = fem.dirichletbc(u_D1, boundary_dofs_b, V.sub(0))

boundary_dofs_b = fem.locate_dofs_topological((V.sub(1), V1), fdim, facet_tag.find(1))
bc1 = fem.dirichletbc(u_D1, boundary_dofs_b, V.sub(1))
